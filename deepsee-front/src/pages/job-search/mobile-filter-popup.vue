...
<template>
    <div class="popup-content column gap-18">
        ...
        <select-input
            ...
            @update:model-value="($event) => emit('update:modelValue', { ...modelValue, contract: $event })"
        />
        ...
        <select-input
            ...
            @update:model-value="($event) => emit('update:modelValue', { ...modelValue, minSalary: $event })"
        />
    </div>
</template>
